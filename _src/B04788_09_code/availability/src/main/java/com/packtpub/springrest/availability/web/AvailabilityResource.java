...
public class AvailabilityResource {
    ...
    public ApiResponse getAvailability(@RequestParam("from") String from,
        ...
        try {
            if (from == null) {
                throw new IllegalArgumentException("from date is mandatory");
            }
            if (until == null) {
                throw new IllegalArgumentException("until date is mandatory");
            }
            ...
            if (request != null && request.checkNotModified(lastUpdatedBooking.getTime())) {
                return null;
            }
            ...
            return new ApiResponse(Status.ERROR, null, new ApiError(1, "General error"));
        }
    }
